package com.Gabriel.todolistjava.controller;

import com.Gabriel.todolistjava.model.Task;
import com.Gabriel.todolistjava.service.TaskService;
...
public class TaskController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 500, message = "Erro ao listar tarefa")
    ...
    @ApiOperation(value = "Buscando as tarefas com id")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Tarefa encontrada com sucesso"),
            @ApiResponse(code = 404, message = "Não foi encontrado nenhuma tarefa")
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 404, message = "Não foi possível atualizar tarefa")
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 404, message = "não foi possível excluir a tarefa")
